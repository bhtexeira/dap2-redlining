...
```{python}
new_path = r"/Users/brandontexeira/dap2-redlining/Data/Raw_Data/data_center_geodata/im3_open_source_data_center_atlas"
...
gpd_path = new_path = r"/Users/brandontexeira/dap2-redlining/Data/Derived_Data/tl_2025_17_tract"
...
```{python}
gdf_merged.to_crs("EPSG:4326")
fig, ax = plt.subplots(figsize=(8, 10))

gdf_merged.plot(ax=ax, edgecolor='#b0b0b0', linewidth=0.6, column='haz_idx', cmap='Reds', legend=True, legend_kwds={'label': "Environmental Hazard Index", 'orientation': "vertical"})
ax.set_axis_off()
plt.show()
```
...
gdf_merged.plot(ax=ax, edgecolor='#b0b0b0', linewidth=0.6, column='pov_idx', cmap='plasma', legend=True, legend_kwds={'label': "Low Poverty Index", 'orientation': "vertical"})
ax.set_axis_off()
plt.show()
```